...
//        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mBackgoundTexID);
//        GLES20.glUniform1i(vbTexSampler2DHandle, 0);
    ...
    public void setBackgroundTexID(int id){ mBackgoundTexID = id; }
}
